class TreeManager {
  ...
  // Private variables
  // TODO : reste _growthLevel
  final int _growthLevel = 2; // Tree grows to next form every 10 level
  ...
  String treeDescription({String userName = ''}) {
    ...
    switch (level) {
      ...
      case 2:
        return '$userName(이)의 줄기가 자랐네요!';
      case 3:
        return '$userName(이)의 잎이 활짝 폈어요!';
      case 4:
        return '$userName(이)에게 꽃봉우리가 생겼네요!';
      case 5:
        return '$userName(이)가 예쁜 꽃을 활짝 폈어요';
      case 6:
        if (_tree == 0) {
          return '$userName(이)가 상수리 나무로 자랐어요!';
        } else if (_tree == 1) {
          return '$userName(이)가 백향목으로 자랐어요!';
        } else {
          return '$userName(이)가 올리브 나무로 자랐어요!';
        }
      default:
